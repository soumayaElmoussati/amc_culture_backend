...
public interface AwardBookProcess {
    ...
    List<PriceBookResponse> getPriceDemandList() throws ParseException;

    List<PriceBookResponse> getPriceDemandListByRefArtist(String refArtistAccount) throws ParseException;
