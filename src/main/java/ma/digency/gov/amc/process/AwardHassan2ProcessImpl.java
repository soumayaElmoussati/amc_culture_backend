...
import ma.digency.gov.amc.repository.ManuscriptInformationRepository;
...
public class AwardHassan2ProcessImpl implements AwardHassan2Process {
    ...
    public List<DocumentDemandResponse> getDocuments(String refDemand) {
        ...
        List<Docum> documents = documentService.findByRefObject(refDemand);
    ...
    public List<DocumentDemandResponse> getDocumentsPersonal(String refArtistAccount) {
        List<DocumentDemandResponse> documentDemandResponses = new ArrayList<>();
        List<Docum> documents = documentService.findByRefObject(refArtistAccount);
        for (Docum document : documents) {
            documentDemandResponses.add(attributionsPrixMapper.documentToDocumentDemandResponse(document));
        }
        return documentDemandResponses;
    ...
    public List<PriceHassa2Response> getPriceDemandList() {
        ...
        for (DemandPrice demandPrice:demandPriceList) {
            ...
            priceHassa2Response.setCreationDate(demandPrice.getDateCreation().toLocalDate());
            ...
            ManuscriptInformationResponse manuscriptInformationResponse = attributionsPrixMapper.manuscriptInformationToManuscriptInformationResponse(manuscriptInformationRepository.findManuscriptInformationByDemand(demandPrice));
            priceHassa2Response.setManuscriptInformation(manuscriptInformationResponse);
    ...
    @Override
    public List<PriceHassa2Response> getPriceDemandListByRefArtist(String refArtistAccount) {
        List<DemandPrice> demandPriceList=demandPriceService.findAllDemandAwardHassan2ByRefArtistAccount(refArtistAccount);
        List<PriceHassa2Response> priceHassa2ResponseList=new ArrayList<>();
