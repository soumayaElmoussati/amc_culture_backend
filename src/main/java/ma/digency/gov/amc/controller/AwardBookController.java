...
public interface AwardBookController {
   ...
   /* @PutMapping("demand/update-artist")
    ...
    ResponseEntity<List<PriceBookResponse>> getPriceDemandList() throws ParseException;

    @GetMapping("priceDemandList/{refArtistAccount}")
    ResponseEntity<List<PriceBookResponse>> getPriceDemandListByRefArtist(@PathVariable("refArtistAccount") String refArtistAccount) throws ParseException;
