...
public class AwardTheaterControllerImpl implements AwardTheaterController{
    ...
    @Override
    public ResponseEntity<List<PriceTheaterResponse>> getPriceDemandList() {
        return ResponseEntity.status(HttpStatus.OK).body(awardTheaterProcess.getPriceDemandList());
    }

    @Override
    public ResponseEntity<List<PriceTheaterResponse>> getPriceDemandListByRefArtist(String refArtistAccount) {
        return ResponseEntity.status(HttpStatus.OK).body(awardTheaterProcess.getPriceDemandListByRefArtist(refArtistAccount));
    }
