...
public interface AwardHonoraryController {
    ...
    ResponseEntity<List<PriceHonoraryResponse>> getPriceDemandList();

    @GetMapping("priceDemandList/{refArtistAccount}")
    ResponseEntity<List<PriceHonoraryResponse>> getPriceDemandListByRefArtist(@PathVariable("refArtistAccount") String refArtistAccount);
