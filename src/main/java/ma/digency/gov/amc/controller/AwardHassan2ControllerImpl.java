...
public class AwardHassan2ControllerImpl implements AwardHassan2Controller {
    ...
    @Override
    public ResponseEntity<List<PriceHassa2Response>> getPriceDemandListByRefArtist(String refArtistAccount) {
        return ResponseEntity.status(HttpStatus.OK).body(awardHassan2Process.getPriceDemandListByRefArtist(refArtistAccount));
    }
