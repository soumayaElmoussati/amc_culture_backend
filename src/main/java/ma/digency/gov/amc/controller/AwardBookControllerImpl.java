...
public class AwardBookControllerImpl implements AwardBookController {
    ...
    @Override
    public ResponseEntity<List<PriceBookResponse>> getPriceDemandList() throws ParseException {
        return ResponseEntity.status(HttpStatus.OK).body( awardBookProcess.getPriceDemandList());
    }

    @Override
    public ResponseEntity<List<PriceBookResponse>> getPriceDemandListByRefArtist(String refArtistAccount) throws ParseException {
        return ResponseEntity.status(HttpStatus.OK).body( awardBookProcess.getPriceDemandListByRefArtist(refArtistAccount));
    }
