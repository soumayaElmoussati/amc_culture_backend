...
public interface AwardTheaterController {
    ...
    ResponseEntity<List<PriceTheaterResponse>> getPriceDemandList();

    @GetMapping("priceDemandList/{refArtistAccount}")
    ResponseEntity<List<PriceTheaterResponse>> getPriceDemandListByRefArtist(@PathVariable("refArtistAccount") String refArtistAccount);
