...
import ma.digency.gov.amc.dto.attributionsPrix1.PriceHonoraryResponse;
...
public class AwardHonoraryControllerImpl implements AwardHonoraryController {
    ...
    @Override
    public ResponseEntity<List<PriceHonoraryResponse>> getPriceDemandList() {
        return ResponseEntity.status(HttpStatus.OK).body(awardHonoraryProcess.getPriceDemandList());
    }

    @Override
    public ResponseEntity<List<PriceHonoraryResponse>> getPriceDemandListByRefArtist(String refArtistAccount) {
        return ResponseEntity.status(HttpStatus.OK).body(awardHonoraryProcess.getPriceDemandListByRefArtist(refArtistAccount));
    }
